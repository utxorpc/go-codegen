...
const (
	...
	QueryServiceName = "utxorpc.v1beta.query.QueryService"
)
...
func NewQueryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) QueryServiceClient {
	...
	queryServiceMethods := query.File_utxorpc_v1beta_query_query_proto.Services().ByName("QueryService").Methods()
...
// ReadUtxos calls utxorpc.v1beta.query.QueryService.ReadUtxos.
...
// SearchUtxos calls utxorpc.v1beta.query.QueryService.SearchUtxos.
...
// ReadData calls utxorpc.v1beta.query.QueryService.ReadData.
...
// ReadTx calls utxorpc.v1beta.query.QueryService.ReadTx.
...
// ReadGenesis calls utxorpc.v1beta.query.QueryService.ReadGenesis.
...
// ReadEraSummary calls utxorpc.v1beta.query.QueryService.ReadEraSummary.
...
func (UnimplementedQueryServiceHandler) ReadParams(context.Context, *connect.Request[query.ReadParamsRequest]) (*connect.Response[query.ReadParamsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.ReadParams is not implemented"))
}
...
func (UnimplementedQueryServiceHandler) ReadUtxos(context.Context, *connect.Request[query.ReadUtxosRequest]) (*connect.Response[query.ReadUtxosResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.ReadUtxos is not implemented"))
}
...
func (UnimplementedQueryServiceHandler) SearchUtxos(context.Context, *connect.Request[query.SearchUtxosRequest]) (*connect.Response[query.SearchUtxosResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.SearchUtxos is not implemented"))
}
...
func (UnimplementedQueryServiceHandler) ReadData(context.Context, *connect.Request[query.ReadDataRequest]) (*connect.Response[query.ReadDataResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.ReadData is not implemented"))
}
...
func (UnimplementedQueryServiceHandler) ReadTx(context.Context, *connect.Request[query.ReadTxRequest]) (*connect.Response[query.ReadTxResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.ReadTx is not implemented"))
}
...
func (UnimplementedQueryServiceHandler) ReadGenesis(context.Context, *connect.Request[query.ReadGenesisRequest]) (*connect.Response[query.ReadGenesisResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.query.QueryService.ReadGenesis is not implemented"))
}
