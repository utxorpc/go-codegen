...
const (
	...
	SyncServiceName = "utxorpc.v1beta.sync.SyncService"
)
...
const (
	...
	SyncServiceFetchBlockProcedure = "/utxorpc.v1beta.sync.SyncService/FetchBlock"
	// SyncServiceDumpHistoryProcedure is the fully-qualified name of the SyncService's DumpHistory RPC.
	SyncServiceDumpHistoryProcedure = "/utxorpc.v1beta.sync.SyncService/DumpHistory"
	// SyncServiceFollowTipProcedure is the fully-qualified name of the SyncService's FollowTip RPC.
	SyncServiceFollowTipProcedure = "/utxorpc.v1beta.sync.SyncService/FollowTip"
	// SyncServiceReadTipProcedure is the fully-qualified name of the SyncService's ReadTip RPC.
	SyncServiceReadTipProcedure = "/utxorpc.v1beta.sync.SyncService/ReadTip"
)

// SyncServiceClient is a client for the utxorpc.v1beta.sync.SyncService service.
...
// NewSyncServiceClient constructs a client for the utxorpc.v1beta.sync.SyncService service. By
...
func NewSyncServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SyncServiceClient {
	...
	syncServiceMethods := sync.File_utxorpc_v1beta_sync_sync_proto.Services().ByName("SyncService").Methods()
...
// FetchBlock calls utxorpc.v1beta.sync.SyncService.FetchBlock.
...
// DumpHistory calls utxorpc.v1beta.sync.SyncService.DumpHistory.
...
// FollowTip calls utxorpc.v1beta.sync.SyncService.FollowTip.
...
// ReadTip calls utxorpc.v1beta.sync.SyncService.ReadTip.
...
// SyncServiceHandler is an implementation of the utxorpc.v1beta.sync.SyncService service.
...
func NewSyncServiceHandler(svc SyncServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1beta.sync.SyncService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSyncServiceHandler) FetchBlock(context.Context, *connect.Request[sync.FetchBlockRequest]) (*connect.Response[sync.FetchBlockResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.sync.SyncService.FetchBlock is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) DumpHistory(context.Context, *connect.Request[sync.DumpHistoryRequest]) (*connect.Response[sync.DumpHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.sync.SyncService.DumpHistory is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) FollowTip(context.Context, *connect.Request[sync.FollowTipRequest], *connect.ServerStream[sync.FollowTipResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.sync.SyncService.FollowTip is not implemented"))
}
...
func (UnimplementedSyncServiceHandler) ReadTip(context.Context, *connect.Request[sync.ReadTipRequest]) (*connect.Response[sync.ReadTipResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.sync.SyncService.ReadTip is not implemented"))
}
