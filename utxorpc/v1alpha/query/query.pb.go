...
const file_utxorpc_v1alpha_query_query_proto_rawDesc = "" +
	...
	"\x06any_of\x18\x04 \x03(\v2$.utxorpc.v1alpha.query.UtxoPredicateR\x05anyOf\"\xb7\x01\n" +
	"\vAnyUtxoData\x12!\n" +
	"\fnative_bytes\x18\x01 \x01(\fR\vnativeBytes\x126\n" +
	"\atxo_ref\x18\x02 \x01(\v2\x1d.utxorpc.v1alpha.query.TxoRefR\x06txoRef\x12=\n" +
	"\acardano\x18\x03 \x01(\v2!.utxorpc.v1alpha.cardano.TxOutputH\x00R\acardanoB\x0e\n" +
...
var file_utxorpc_v1alpha_query_query_proto_depIdxs = []int32{
	...
	2,  // 16: utxorpc.v1alpha.query.ReadUtxosRequest.keys:type_name -> utxorpc.v1alpha.query.TxoRef
	24, // 17: utxorpc.v1alpha.query.ReadUtxosRequest.field_mask:type_name -> google.protobuf.FieldMask
	12, // 18: utxorpc.v1alpha.query.ReadUtxosResponse.items:type_name -> utxorpc.v1alpha.query.AnyUtxoData
	0,  // 19: utxorpc.v1alpha.query.ReadUtxosResponse.ledger_tip:type_name -> utxorpc.v1alpha.query.ChainPoint
	11, // 20: utxorpc.v1alpha.query.SearchUtxosRequest.predicate:type_name -> utxorpc.v1alpha.query.UtxoPredicate
	24, // 21: utxorpc.v1alpha.query.SearchUtxosRequest.field_mask:type_name -> google.protobuf.FieldMask
	12, // 22: utxorpc.v1alpha.query.SearchUtxosResponse.items:type_name -> utxorpc.v1alpha.query.AnyUtxoData
	0,  // 23: utxorpc.v1alpha.query.SearchUtxosResponse.ledger_tip:type_name -> utxorpc.v1alpha.query.ChainPoint
	24, // 24: utxorpc.v1alpha.query.ReadDataRequest.field_mask:type_name -> google.protobuf.FieldMask
	30, // 25: utxorpc.v1alpha.query.AnyChainDatum.cardano:type_name -> utxorpc.v1alpha.cardano.PlutusData
	18, // 26: utxorpc.v1alpha.query.ReadDataResponse.values:type_name -> utxorpc.v1alpha.query.AnyChainDatum
	0,  // 27: utxorpc.v1alpha.query.ReadDataResponse.ledger_tip:type_name -> utxorpc.v1alpha.query.ChainPoint
	24, // 28: utxorpc.v1alpha.query.ReadTxRequest.field_mask:type_name -> google.protobuf.FieldMask
	31, // 29: utxorpc.v1alpha.query.AnyChainTx.cardano:type_name -> utxorpc.v1alpha.cardano.Tx
	0,  // 30: utxorpc.v1alpha.query.AnyChainTx.block_ref:type_name -> utxorpc.v1alpha.query.ChainPoint
	21, // 31: utxorpc.v1alpha.query.ReadTxResponse.tx:type_name -> utxorpc.v1alpha.query.AnyChainTx
	0,  // 32: utxorpc.v1alpha.query.ReadTxResponse.ledger_tip:type_name -> utxorpc.v1alpha.query.ChainPoint
	3,  // 33: utxorpc.v1alpha.query.QueryService.ReadParams:input_type -> utxorpc.v1alpha.query.ReadParamsRequest
	13, // 34: utxorpc.v1alpha.query.QueryService.ReadUtxos:input_type -> utxorpc.v1alpha.query.ReadUtxosRequest
	15, // 35: utxorpc.v1alpha.query.QueryService.SearchUtxos:input_type -> utxorpc.v1alpha.query.SearchUtxosRequest
	17, // 36: utxorpc.v1alpha.query.QueryService.ReadData:input_type -> utxorpc.v1alpha.query.ReadDataRequest
	20, // 37: utxorpc.v1alpha.query.QueryService.ReadTx:input_type -> utxorpc.v1alpha.query.ReadTxRequest
	4,  // 38: utxorpc.v1alpha.query.QueryService.ReadGenesis:input_type -> utxorpc.v1alpha.query.ReadGenesisRequest
	5,  // 39: utxorpc.v1alpha.query.QueryService.ReadEraSummary:input_type -> utxorpc.v1alpha.query.ReadEraSummaryRequest
	9,  // 40: utxorpc.v1alpha.query.QueryService.ReadParams:output_type -> utxorpc.v1alpha.query.ReadParamsResponse
	14, // 41: utxorpc.v1alpha.query.QueryService.ReadUtxos:output_type -> utxorpc.v1alpha.query.ReadUtxosResponse
	16, // 42: utxorpc.v1alpha.query.QueryService.SearchUtxos:output_type -> utxorpc.v1alpha.query.SearchUtxosResponse
	19, // 43: utxorpc.v1alpha.query.QueryService.ReadData:output_type -> utxorpc.v1alpha.query.ReadDataResponse
	22, // 44: utxorpc.v1alpha.query.QueryService.ReadTx:output_type -> utxorpc.v1alpha.query.ReadTxResponse
	6,  // 45: utxorpc.v1alpha.query.QueryService.ReadGenesis:output_type -> utxorpc.v1alpha.query.ReadGenesisResponse
	7,  // 46: utxorpc.v1alpha.query.QueryService.ReadEraSummary:output_type -> utxorpc.v1alpha.query.ReadEraSummaryResponse
