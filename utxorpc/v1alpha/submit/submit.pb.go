...
type EvalTxRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tx            *AnyChainTx            `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"` // A transaction to evaluate.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EvalTxResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Report        *AnyChainEval          `protobuf:"bytes,1,opt,name=report,proto3" json:"report,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubmitTxRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tx            *AnyChainTx            `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"` // A transaction to submit.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubmitTxResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ref           []byte                 `protobuf:"bytes,1,opt,name=ref,proto3" json:"ref,omitempty"` // A transaction reference returned upon successful submission.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
