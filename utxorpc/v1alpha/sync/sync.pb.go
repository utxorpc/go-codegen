...
type ReadTipResponse struct {
	...
	Timestamp     uint64                 `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Block ms timestamp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadTipResponse) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
const file_utxorpc_v1alpha_sync_sync_proto_rawDesc = "" +
	...
	"\n" +
	"field_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask\"\xcd\x01\n" +
	...
	"\x05reset\x18\x03 \x01(\v2\x1e.utxorpc.v1alpha.sync.BlockRefH\x00R\x05resetB\b\n" +
	"\x06action\"\x10\n" +
	"\x0eReadTipRequest\"a\n" +
	"\x0fReadTipResponse\x120\n" +
	"\x03tip\x18\x01 \x01(\v2\x1e.utxorpc.v1alpha.sync.BlockRefR\x03tip\x12\x1c\n" +
