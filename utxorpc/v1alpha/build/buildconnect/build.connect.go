...
const (
	...
	LedgerStateServiceName = "utxorpc.v1alpha.build.LedgerStateService"
)
...
const (
	...
	// GetChainTip RPC.
	LedgerStateServiceGetChainTipProcedure = "/utxorpc.v1alpha.build.LedgerStateService/GetChainTip"
	// LedgerStateServiceGetChainParamProcedure is the fully-qualified name of the LedgerStateService's
	// GetChainParam RPC.
	LedgerStateServiceGetChainParamProcedure = "/utxorpc.v1alpha.build.LedgerStateService/GetChainParam"
	// LedgerStateServiceGetUtxoByAddressProcedure is the fully-qualified name of the
	// LedgerStateService's GetUtxoByAddress RPC.
	LedgerStateServiceGetUtxoByAddressProcedure = "/utxorpc.v1alpha.build.LedgerStateService/GetUtxoByAddress"
	// LedgerStateServiceGetUtxoByRefProcedure is the fully-qualified name of the LedgerStateService's
	// GetUtxoByRef RPC.
	LedgerStateServiceGetUtxoByRefProcedure = "/utxorpc.v1alpha.build.LedgerStateService/GetUtxoByRef"
	// LedgerStateServiceHoldUtxoProcedure is the fully-qualified name of the LedgerStateService's
	// HoldUtxo RPC.
	LedgerStateServiceHoldUtxoProcedure = "/utxorpc.v1alpha.build.LedgerStateService/HoldUtxo"
)
...
// LedgerStateServiceClient is a client for the utxorpc.v1alpha.build.LedgerStateService service.
...
// NewLedgerStateServiceClient constructs a client for the utxorpc.v1alpha.build.LedgerStateService
...
// GetChainTip calls utxorpc.v1alpha.build.LedgerStateService.GetChainTip.
...
// GetChainParam calls utxorpc.v1alpha.build.LedgerStateService.GetChainParam.
...
// GetUtxoByAddress calls utxorpc.v1alpha.build.LedgerStateService.GetUtxoByAddress.
...
// GetUtxoByRef calls utxorpc.v1alpha.build.LedgerStateService.GetUtxoByRef.
...
// HoldUtxo calls utxorpc.v1alpha.build.LedgerStateService.HoldUtxo.
...
// LedgerStateServiceHandler is an implementation of the utxorpc.v1alpha.build.LedgerStateService
// service.
...
func NewLedgerStateServiceHandler(svc LedgerStateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1alpha.build.LedgerStateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLedgerStateServiceHandler) GetChainTip(context.Context, *connect.Request[build.GetChainTipRequest]) (*connect.Response[build.GetChainTipResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1alpha.build.LedgerStateService.GetChainTip is not implemented"))
}
...
func (UnimplementedLedgerStateServiceHandler) GetChainParam(context.Context, *connect.Request[build.GetChainParamRequest]) (*connect.Response[build.GetChainParamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1alpha.build.LedgerStateService.GetChainParam is not implemented"))
}
...
func (UnimplementedLedgerStateServiceHandler) GetUtxoByAddress(context.Context, *connect.Request[build.GetUtxoByAddressRequest]) (*connect.Response[build.GetUtxoByAddressResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1alpha.build.LedgerStateService.GetUtxoByAddress is not implemented"))
}
...
func (UnimplementedLedgerStateServiceHandler) GetUtxoByRef(context.Context, *connect.Request[build.GetUtxoByRefRequest]) (*connect.Response[build.GetUtxoByRefResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1alpha.build.LedgerStateService.GetUtxoByRef is not implemented"))
}
...
func (UnimplementedLedgerStateServiceHandler) HoldUtxo(context.Context, *connect.Request[build.HoldUtxoRequest], *connect.ServerStream[build.HoldUtxoResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1alpha.build.LedgerStateService.HoldUtxo is not implemented"))
}
