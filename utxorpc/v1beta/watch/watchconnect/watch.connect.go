...
import (
	...
	context "context"
	errors "errors"
	watch "github.com/utxorpc/go-codegen/utxorpc/v1beta/watch"
	http "net/http"
	strings "strings"
)
...
const (
	...
	WatchServiceName = "utxorpc.v1beta.watch.WatchService"
)
...
const (
	...
	WatchServiceWatchTxProcedure = "/utxorpc.v1beta.watch.WatchService/WatchTx"
)

// WatchServiceClient is a client for the utxorpc.v1beta.watch.WatchService service.
...
// NewWatchServiceClient constructs a client for the utxorpc.v1beta.watch.WatchService service. By
...
func NewWatchServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WatchServiceClient {
	...
	watchServiceMethods := watch.File_utxorpc_v1beta_watch_watch_proto.Services().ByName("WatchService").Methods()
...
// WatchTx calls utxorpc.v1beta.watch.WatchService.WatchTx.
...
// WatchServiceHandler is an implementation of the utxorpc.v1beta.watch.WatchService service.
...
func NewWatchServiceHandler(svc WatchServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1beta.watch.WatchService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWatchServiceHandler) WatchTx(context.Context, *connect.Request[watch.WatchTxRequest], *connect.ServerStream[watch.WatchTxResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.watch.WatchService.WatchTx is not implemented"))
}
