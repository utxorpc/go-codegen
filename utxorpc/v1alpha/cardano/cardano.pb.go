...
var file_utxorpc_v1alpha_cardano_cardano_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x91, 0x05, 0x0a, 0x0b, 0x43, 0x65, 0x72,
	...
	0x72, 0x74, 0x48, 0x00, 0x52, 0x07, 0x6d, 0x69, 0x72, 0x43, 0x65, 0x72, 0x74, 0x42, 0x0d, 0x0a,
...
var file_utxorpc_v1alpha_cardano_cardano_proto_depIdxs = []int32{
	...
	43, // 64: utxorpc.v1alpha.cardano.TxOutputPattern.address:type_name -> utxorpc.v1alpha.cardano.AddressPattern
	44, // 65: utxorpc.v1alpha.cardano.TxOutputPattern.asset:type_name -> utxorpc.v1alpha.cardano.AssetPattern
	45, // 66: utxorpc.v1alpha.cardano.TxPattern.consumes:type_name -> utxorpc.v1alpha.cardano.TxOutputPattern
	45, // 67: utxorpc.v1alpha.cardano.TxPattern.produces:type_name -> utxorpc.v1alpha.cardano.TxOutputPattern
	43, // 68: utxorpc.v1alpha.cardano.TxPattern.has_address:type_name -> utxorpc.v1alpha.cardano.AddressPattern
	44, // 69: utxorpc.v1alpha.cardano.TxPattern.moves_asset:type_name -> utxorpc.v1alpha.cardano.AssetPattern
	44, // 70: utxorpc.v1alpha.cardano.TxPattern.mints_asset:type_name -> utxorpc.v1alpha.cardano.AssetPattern
	33, // 71: utxorpc.v1alpha.cardano.ExPrices.steps:type_name -> utxorpc.v1alpha.cardano.RationalNumber
	33, // 72: utxorpc.v1alpha.cardano.ExPrices.memory:type_name -> utxorpc.v1alpha.cardano.RationalNumber
	50, // 73: utxorpc.v1alpha.cardano.CostModels.plutus_v1:type_name -> utxorpc.v1alpha.cardano.CostModel
	50, // 74: utxorpc.v1alpha.cardano.CostModels.plutus_v2:type_name -> utxorpc.v1alpha.cardano.CostModel
	33, // 75: utxorpc.v1alpha.cardano.PParams.pool_influence:type_name -> utxorpc.v1alpha.cardano.RationalNumber
	33, // 76: utxorpc.v1alpha.cardano.PParams.monetary_expansion:type_name -> utxorpc.v1alpha.cardano.RationalNumber
	33, // 77: utxorpc.v1alpha.cardano.PParams.treasury_expansion:type_name -> utxorpc.v1alpha.cardano.RationalNumber
	49, // 78: utxorpc.v1alpha.cardano.PParams.protocol_version:type_name -> utxorpc.v1alpha.cardano.ProtocolVersion
	51, // 79: utxorpc.v1alpha.cardano.PParams.cost_models:type_name -> utxorpc.v1alpha.cardano.CostModels
	48, // 80: utxorpc.v1alpha.cardano.PParams.prices:type_name -> utxorpc.v1alpha.cardano.ExPrices
	47, // 81: utxorpc.v1alpha.cardano.PParams.max_execution_units_per_transaction:type_name -> utxorpc.v1alpha.cardano.ExUnits
	47, // 82: utxorpc.v1alpha.cardano.PParams.max_execution_units_per_block:type_name -> utxorpc.v1alpha.cardano.ExUnits
	47, // 83: utxorpc.v1alpha.cardano.TxEval.ex_units:type_name -> utxorpc.v1alpha.cardano.ExUnits
	53, // 84: utxorpc.v1alpha.cardano.TxEval.errors:type_name -> utxorpc.v1alpha.cardano.EvalError
	54, // 85: utxorpc.v1alpha.cardano.TxEval.traces:type_name -> utxorpc.v1alpha.cardano.EvalTrace
