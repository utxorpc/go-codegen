...
const (
	...
	SubmitServiceName = "utxorpc.v1beta.submit.SubmitService"
)
...
const (
	...
	SubmitServiceEvalTxProcedure = "/utxorpc.v1beta.submit.SubmitService/EvalTx"
	// SubmitServiceSubmitTxProcedure is the fully-qualified name of the SubmitService's SubmitTx RPC.
	SubmitServiceSubmitTxProcedure = "/utxorpc.v1beta.submit.SubmitService/SubmitTx"
	// SubmitServiceWaitForTxProcedure is the fully-qualified name of the SubmitService's WaitForTx RPC.
	SubmitServiceWaitForTxProcedure = "/utxorpc.v1beta.submit.SubmitService/WaitForTx"
	// SubmitServiceReadMempoolProcedure is the fully-qualified name of the SubmitService's ReadMempool
	// RPC.
	SubmitServiceReadMempoolProcedure = "/utxorpc.v1beta.submit.SubmitService/ReadMempool"
	// SubmitServiceWatchMempoolProcedure is the fully-qualified name of the SubmitService's
	// WatchMempool RPC.
	SubmitServiceWatchMempoolProcedure = "/utxorpc.v1beta.submit.SubmitService/WatchMempool"
)

// SubmitServiceClient is a client for the utxorpc.v1beta.submit.SubmitService service.
...
// NewSubmitServiceClient constructs a client for the utxorpc.v1beta.submit.SubmitService service.
...
func NewSubmitServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SubmitServiceClient {
	...
	submitServiceMethods := submit.File_utxorpc_v1beta_submit_submit_proto.Services().ByName("SubmitService").Methods()
...
// EvalTx calls utxorpc.v1beta.submit.SubmitService.EvalTx.
...
// SubmitTx calls utxorpc.v1beta.submit.SubmitService.SubmitTx.
...
// WaitForTx calls utxorpc.v1beta.submit.SubmitService.WaitForTx.
...
// ReadMempool calls utxorpc.v1beta.submit.SubmitService.ReadMempool.
...
// WatchMempool calls utxorpc.v1beta.submit.SubmitService.WatchMempool.
...
// SubmitServiceHandler is an implementation of the utxorpc.v1beta.submit.SubmitService service.
...
func NewSubmitServiceHandler(svc SubmitServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1beta.submit.SubmitService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSubmitServiceHandler) EvalTx(context.Context, *connect.Request[submit.EvalTxRequest]) (*connect.Response[submit.EvalTxResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.submit.SubmitService.EvalTx is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) SubmitTx(context.Context, *connect.Request[submit.SubmitTxRequest]) (*connect.Response[submit.SubmitTxResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.submit.SubmitService.SubmitTx is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) WaitForTx(context.Context, *connect.Request[submit.WaitForTxRequest], *connect.ServerStream[submit.WaitForTxResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.submit.SubmitService.WaitForTx is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) ReadMempool(context.Context, *connect.Request[submit.ReadMempoolRequest]) (*connect.Response[submit.ReadMempoolResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.submit.SubmitService.ReadMempool is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) WatchMempool(context.Context, *connect.Request[submit.WatchMempoolRequest], *connect.ServerStream[submit.WatchMempoolResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1beta.submit.SubmitService.WatchMempool is not implemented"))
}
