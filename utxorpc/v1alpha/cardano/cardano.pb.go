...
type AddressPattern struct {
	...
	ByronAddress       []byte `protobuf:"bytes,1,opt,name=byron_address,json=byronAddress,proto3" json:"byron_address,omitempty"`                      // The address should match this exact Byron address value.
	...
	PaymentIsScript    bool   `protobuf:"varint,4,opt,name=payment_is_script,json=paymentIsScript,proto3" json:"payment_is_script,omitempty"`          // The payment part of the address is a script.
	DelegationIsScript bool   `protobuf:"varint,5,opt,name=delegation_is_script,json=delegationIsScript,proto3" json:"delegation_is_script,omitempty"` // The delegation part of the address is a script.
}
...
type CoinPattern struct {
	...
	ExactValue int64 `protobuf:"varint,1,opt,name=exact_value,json=exactValue,proto3" json:"exact_value,omitempty"` // The value should be exactly this amount
	UpperBound int64 `protobuf:"varint,2,opt,name=upper_bound,json=upperBound,proto3" json:"upper_bound,omitempty"` // The value should be at most this amount (inclusive)
	LowerBound int64 `protobuf:"varint,3,opt,name=lower_bound,json=lowerBound,proto3" json:"lower_bound,omitempty"` // The value should be at leaste this amount (inclusive)
}

func (x *CoinPattern) Reset() {
	*x = CoinPattern{}
	if protoimpl.UnsafeEnabled {
...
func (x *CoinPattern) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoinPattern) ProtoMessage() {}

func (x *CoinPattern) ProtoReflect() protoreflect.Message {
	mi := &file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoinPattern.ProtoReflect.Descriptor instead.
func (*CoinPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_v1alpha_cardano_cardano_proto_rawDescGZIP(), []int{42}
}

func (x *CoinPattern) GetExactValue() int64 {
	if x != nil {
		return x.ExactValue
	}
	return 0
...
func (x *CoinPattern) GetUpperBound() int64 {
	if x != nil {
		return x.UpperBound
	}
	return 0
...
func (x *CoinPattern) GetLowerBound() int64 {
	if x != nil {
		return x.LowerBound
	}
	return 0
...
type AssetPattern struct {
	...
	CoinPattern *CoinPattern `protobuf:"bytes,3,opt,name=coin_pattern,json=coinPattern,proto3" json:"coin_pattern,omitempty"` // The amount of the asset should match this pattern
}
...
func (x *AssetPattern) GetCoinPattern() *CoinPattern {
	if x != nil {
		return x.CoinPattern
	}
	return nil
}

// Pattern of multiple native asset that can be used to evaluate matching predicates.
type MultiAssetPattern struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LovalacePattern *CoinPattern    `protobuf:"bytes,1,opt,name=lovalace_pattern,json=lovalacePattern,proto3" json:"lovalace_pattern,omitempty"` // The multi-asset should exhibit this lovelace pattern
	AssetPatterns   []*AssetPattern `protobuf:"bytes,2,rep,name=asset_patterns,json=assetPatterns,proto3" json:"asset_patterns,omitempty"`       // The multi-asset should exhibit this asset patterns simultanously.
}

func (x *MultiAssetPattern) Reset() {
	*x = MultiAssetPattern{}
	if protoimpl.UnsafeEnabled {
...
func (x *MultiAssetPattern) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MultiAssetPattern) ProtoMessage() {}

func (x *MultiAssetPattern) ProtoReflect() protoreflect.Message {
	mi := &file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MultiAssetPattern.ProtoReflect.Descriptor instead.
func (*MultiAssetPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_v1alpha_cardano_cardano_proto_rawDescGZIP(), []int{44}
}

func (x *MultiAssetPattern) GetLovalacePattern() *CoinPattern {
	if x != nil {
		return x.LovalacePattern
	}
	return nil
}

func (x *MultiAssetPattern) GetAssetPatterns() []*AssetPattern {
	if x != nil {
...
type OutputPattern struct {
	...
	AnyAddress      *AddressPattern    `protobuf:"bytes,1,opt,name=any_address,json=anyAddress,proto3" json:"any_address,omitempty"`                // Match any address in the output that exhibits this pattern.
	AnyAsset        *MultiAssetPattern `protobuf:"bytes,2,opt,name=any_asset,json=anyAsset,proto3" json:"any_asset,omitempty"`                      // Match any asset in the output that exhibits this pattern.
	LovelacePattern *CoinPattern       `protobuf:"bytes,3,opt,name=lovelace_pattern,json=lovelacePattern,proto3" json:"lovelace_pattern,omitempty"` // Match the Lovelace amount in the output that exhibits this pattern.
}
...
func (x *OutputPattern) GetAnyAddress() *AddressPattern {
	if x != nil {
		return x.AnyAddress
	}
	return nil
...
func (x *OutputPattern) GetAnyAsset() *MultiAssetPattern {
	if x != nil {
		return x.AnyAsset
	}
	return nil
...
func (x *OutputPattern) GetLovelacePattern() *CoinPattern {
	if x != nil {
		return x.LovelacePattern
	}
	return nil
}
...
type InputPattern struct {
	...
	Address         *AddressPattern    `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`                                               // Match the input with an address that exhibits this pattern.
	AnyAsset        *MultiAssetPattern `protobuf:"bytes,2,opt,name=any_asset,json=anyAsset,proto3" json:"any_asset,omitempty"`                             // Match the input with any asset that exhibits this pattern.
	LovelacePattern *CoinPattern       `protobuf:"bytes,3,opt,name=lovelace_pattern,json=lovelacePattern,proto3" json:"lovelace_pattern,omitempty"`        // Match the Lovelace amount in the input that exhibits this pattern.
	Purpose         RedeemerPurpose    `protobuf:"varint,4,opt,name=purpose,proto3,enum=utxorpc.v1alpha.cardano.RedeemerPurpose" json:"purpose,omitempty"` // Math the input that has this redeemer purpose.
	Redeemer        *DatumPattern      `protobuf:"bytes,5,opt,name=redeemer,proto3" json:"redeemer,omitempty"`                                             // Match the input with a redeemer exhibits this pattern.
}

func (x *InputPattern) Reset() {
	*x = InputPattern{}
	if protoimpl.UnsafeEnabled {
...
func (x *InputPattern) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InputPattern) ProtoMessage() {}

func (x *InputPattern) ProtoReflect() protoreflect.Message {
	mi := &file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InputPattern.ProtoReflect.Descriptor instead.
func (*InputPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_v1alpha_cardano_cardano_proto_rawDescGZIP(), []int{46}
}

func (x *InputPattern) GetAddress() *AddressPattern {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *InputPattern) GetAnyAsset() *MultiAssetPattern {
	if x != nil {
		return x.AnyAsset
	}
	return nil
...
func (x *InputPattern) GetLovelacePattern() *CoinPattern {
	if x != nil {
		return x.LovelacePattern
	}
	return nil
...
func (x *InputPattern) GetPurpose() RedeemerPurpose {
	if x != nil {
		return x.Purpose
	}
	return RedeemerPurpose_REDEEMER_PURPOSE_UNSPECIFIED
...
func (x *InputPattern) GetRedeemer() *DatumPattern {
	if x != nil {
		return x.Redeemer
	}
	return nil
...
type DatumPattern struct {
	...
	Hash []byte `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"` // Math the datum that exhibits this hash value.
}
...
func (x *DatumPattern) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *TxPattern) GetAnyInput() *InputPattern {
	if x, ok := x.GetTxPattern().(*TxPattern_AnyInput); ok {
		return x.AnyInput
	}
	return nil
}
...
func (x *TxPattern) GetAnyAsset() *MultiAssetPattern {
...
type TxPattern_AnyInput struct {
	AnyInput *InputPattern `protobuf:"bytes,1,opt,name=any_input,json=anyInput,proto3,oneof"` // Match any input that exhibits this pattern.
}

type TxPattern_AnyOutput struct {
	AnyOutput *OutputPattern `protobuf:"bytes,2,opt,name=any_output,json=anyOutput,proto3,oneof"` // Match any output that exhibits this pattern.
}

type TxPattern_AnyAddress struct {
	AnyAddress *AddressPattern `protobuf:"bytes,3,opt,name=any_address,json=anyAddress,proto3,oneof"` // Match any address (inputs, outputs, collateral, etc) that exhibits this pattern.
}

type TxPattern_AnyAsset struct {
	AnyAsset *MultiAssetPattern `protobuf:"bytes,4,opt,name=any_asset,json=anyAsset,proto3,oneof"` // Match any asset that exhibits this pattern.
}

type TxPattern_AnyDatum struct {
	AnyDatum *DatumPattern `protobuf:"bytes,5,opt,name=any_datum,json=anyDatum,proto3,oneof"` // Match any datum that exhibits this pattern.
}

func (*TxPattern_AnyInput) isTxPattern_TxPattern() {}
...
var file_utxorpc_v1alpha_cardano_cardano_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x50, 0x6f, 0x74, 0x22, 0xdf, 0x01, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x62, 0x79, 0x72, 0x6f,
	0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0c, 0x62, 0x79, 0x72, 0x6f, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21, 0x0a,
	...
	,
	...
	,
...
var file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_utxorpc_v1alpha_cardano_cardano_proto_goTypes = []interface{}{
	...
	(*CoinPattern)(nil),              // 44: utxorpc.v1alpha.cardano.CoinPattern
	(*AssetPattern)(nil),             // 45: utxorpc.v1alpha.cardano.AssetPattern
	(*MultiAssetPattern)(nil),        // 46: utxorpc.v1alpha.cardano.MultiAssetPattern
	(*OutputPattern)(nil),            // 47: utxorpc.v1alpha.cardano.OutputPattern
	(*InputPattern)(nil),             // 48: utxorpc.v1alpha.cardano.InputPattern
	(*DatumPattern)(nil),             // 49: utxorpc.v1alpha.cardano.DatumPattern
	(*TxPattern)(nil),                // 50: utxorpc.v1alpha.cardano.TxPattern
}
var file_utxorpc_v1alpha_cardano_cardano_proto_depIdxs = []int32{
	...
	44, // 64: utxorpc.v1alpha.cardano.AssetPattern.coin_pattern:type_name -> utxorpc.v1alpha.cardano.CoinPattern
	44, // 65: utxorpc.v1alpha.cardano.MultiAssetPattern.lovalace_pattern:type_name -> utxorpc.v1alpha.cardano.CoinPattern
	45, // 66: utxorpc.v1alpha.cardano.MultiAssetPattern.asset_patterns:type_name -> utxorpc.v1alpha.cardano.AssetPattern
	43, // 67: utxorpc.v1alpha.cardano.OutputPattern.any_address:type_name -> utxorpc.v1alpha.cardano.AddressPattern
	46, // 68: utxorpc.v1alpha.cardano.OutputPattern.any_asset:type_name -> utxorpc.v1alpha.cardano.MultiAssetPattern
	44, // 69: utxorpc.v1alpha.cardano.OutputPattern.lovelace_pattern:type_name -> utxorpc.v1alpha.cardano.CoinPattern
	43, // 70: utxorpc.v1alpha.cardano.InputPattern.address:type_name -> utxorpc.v1alpha.cardano.AddressPattern
	46, // 71: utxorpc.v1alpha.cardano.InputPattern.any_asset:type_name -> utxorpc.v1alpha.cardano.MultiAssetPattern
	44, // 72: utxorpc.v1alpha.cardano.InputPattern.lovelace_pattern:type_name -> utxorpc.v1alpha.cardano.CoinPattern
	0,  // 73: utxorpc.v1alpha.cardano.InputPattern.purpose:type_name -> utxorpc.v1alpha.cardano.RedeemerPurpose
	49, // 74: utxorpc.v1alpha.cardano.InputPattern.redeemer:type_name -> utxorpc.v1alpha.cardano.DatumPattern
	48, // 75: utxorpc.v1alpha.cardano.TxPattern.any_input:type_name -> utxorpc.v1alpha.cardano.InputPattern
	47, // 76: utxorpc.v1alpha.cardano.TxPattern.any_output:type_name -> utxorpc.v1alpha.cardano.OutputPattern
	43, // 77: utxorpc.v1alpha.cardano.TxPattern.any_address:type_name -> utxorpc.v1alpha.cardano.AddressPattern
	46, // 78: utxorpc.v1alpha.cardano.TxPattern.any_asset:type_name -> utxorpc.v1alpha.cardano.MultiAssetPattern
	49, // 79: utxorpc.v1alpha.cardano.TxPattern.any_datum:type_name -> utxorpc.v1alpha.cardano.DatumPattern
...
func file_utxorpc_v1alpha_cardano_cardano_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MultiAssetPattern); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InputPattern); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
	...
	file_utxorpc_v1alpha_cardano_cardano_proto_msgTypes[48].OneofWrappers = []interface{}{
		(*TxPattern_AnyInput)(nil),
